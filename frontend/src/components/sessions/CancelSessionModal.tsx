...
const CancelSessionModal = ({
  ...
  const handleConfirmCancel = () => {
    const success = cancelSession(session.id);
    if (success) {
      setIsSuccess(true);
    }
  };
        ...
        {isSuccess ? (
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Your session with <span className="font-semibold text-slate-700">{session.mentor}</span> has been marked as cancelled.
            </p>

            {/* Status box */}
            <div className="mt-6 flex items-center gap-3 rounded-2xl border border-red-100 bg-red-50/70 px-5 py-3 text-sm">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Are you sure you want to cancel this session? This action will mark the session as cancelled.
                </p>
              </div>
            </div>
