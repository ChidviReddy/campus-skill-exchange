      ...
      <div className="flex items-center justify-between">
        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <button className="flex cursor-pointer items-center gap-2 rounded-xl bg-white px-6 py-3 font-semibold text-violet-700 transition hover:scale-105">
              <Search size={18} />
              Find a Teacher
            </button>

            <button className="flex cursor-pointer items-center gap-2 rounded-xl border border-white/30 bg-white/10 px-6 py-3 font-medium backdrop-blur transition hover:bg-white/20">
              <ArrowRight size={18} />
              Offer a Skill
            </button>
